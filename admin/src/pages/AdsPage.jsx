...
import { BarChart2, RefreshCw, TrendingUp, TrendingDown, ChevronDown, ChevronRight, AlertCircle } from 'lucide-react';
...
export default function AdsPage() {
  ...
  const accountsToFetch = selectedAccount === 'all' ? AD_ACCOUNTS.map(a => a.id) : [selectedAccount];
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-6 py-3 flex items-center gap-4">
          ...
          >
            ...
            {AD_ACCOUNTS.map(a => <option key={a.id} value={a.id}>{a.name}</option>)}
          </select>
