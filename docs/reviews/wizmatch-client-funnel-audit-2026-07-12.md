...
- **D-22 · Currency is mixed.** Placements shows `$0/hr margin`; Analytics shows `₹0` monthly margin; Client Discovery shows `cost ₹0`; the guardrail JSON says `Rs 25 / Rs 500`.
